...
@Suite struct TimestampTests {
  @Test(
    ...
    arguments: [
      GoogleWKT.Timestamp.maxSeconds + 1,
      GoogleWKT.Timestamp.minSeconds - 1,
    ])
  func outOfRangeSeconds(_ seconds: Int64) throws {
    #expect(throws: GoogleWKT.TimestampError.outOfRange) {
      try GoogleWKT.Timestamp(seconds: seconds, nanos: 0)
    }
  }
  ...
  @Test(
    ...
    arguments: [
      ("0001-01-01T00:00:00Z", GoogleWKT.Timestamp.minSeconds, 0),
      ...
      ("9999-12-31T23:59:59Z", GoogleWKT.Timestamp.maxSeconds, 0),
  ...
  func roundtripString(_ input: String) throws {
    let ts = try GoogleWKT.Timestamp(fromString: input)
  ...
  @Test(
    ...
    arguments: [
      ...
      (GoogleWKT.Timestamp.minSeconds, 0, "{\"value\":\"0001-01-01T00:00:00Z\"}"),
    ]
  )
  ...
  @Test(
    ...
    arguments: [
      ...
      ("{\"value\":\"0001-01-01T00:00:00Z\"}", GoogleWKT.Timestamp.minSeconds, 0),
